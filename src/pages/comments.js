...
class Comments extends Component {
                  ...
                  if (comment.isReply) {
                    return (
                      ...
                      >
                        ...
                        <Text style={{ fontSize: 12, color: colors.black, marginBottom: 5, marginTop: 5 }}>
                          {comment.repliedComment.name}
                        </Text>
                        <Text
                          numberOfLines={2}
                          ellipsizeMode="middle"
                          style={{ fontSize: 16, color: colors.black, marginBottom: 5 }}
                        >
  ...
  render() {
    return <KeyboardAwareScrollView>{this._renderSection()}</KeyboardAwareScrollView>;
  }
}

...
import { View, Text, Image, Alert, TextInput, TouchableHighlight, ScrollView, ActivityIndicator } from 'react-native';
        ...
        <KeyboardAwareScrollView>
          <View style={[main.content, { flex: 1, flexDirection: 'column' }]}>
            ...
            <View style={{ flex: 0.2, paddingTop: 50 }}>
              ...
              <TextInput
                ...
                style={[
                  main.textInput,
                  {
                    backgroundColor: this.state.submitted && this.state.name.length < 3 ? colors.red : colors.white,
                    paddingLeft: 10,
                  },
                ]}
              ...
              <TextInput
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      this.state.submitted && !this._validEmail(this.state.email) ? colors.red : colors.white,
                    paddingLeft: 10,
                  },
                ]}
              ...
              {this._renderError(
                this.state.submitted && !this._validEmail(this.state.email),
              ...
              <TextInput
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      this.state.submitted && !this._validPhone(this.state.phoneNumber) ? colors.red : colors.white,
                    paddingLeft: 10,
                  },
                ]}
              ...
              <TextInput
                ...
                style={[
                  main.textInput,
                  {
                    backgroundColor: this.state.submitted && this.state.password.length < 6 ? colors.red : colors.white,
                    paddingLeft: 10,
                  },
                ]}
            ...
            <View style={{ height: 100, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Button text="Sign Up" onPress={this._signUp.bind(this)} />
            </View>
            <ButtonInActive onPress={() => navigator.signIn(this.props)} text="I Already Have An Account" />

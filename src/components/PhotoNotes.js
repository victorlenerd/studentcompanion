...
class PhotoNotes extends Component {
  ...
  componentDidMount() {
    this.props
      ...
      .then(user => {
        ...
        Promise.all([this.props.getPhotoNotes(user.$id)])
          .then(results => {
  ...
  _done = () => {
    ...
    if (this.state.images.length < 1) {
      Alert.alert('Err!', 'You need to upload some photos', [{ text: 'Cancel', style: 'cancel' }]);
    } else {
      let newPhotoNote = {
  ...
  _isFormValid = () => {
    if (
      ...
      this.state.selectedSemester.length < 1 ||
  ...
  _renderError(condition, text) {
    if (condition) {
      return <Text style={{ fontSize: 16, color: colors.red }}>{text}</Text>;
    }
  }
                ...
                <View style={{ marginTop: 30 }}>
                  ...
                  >
                    {this.state.type.map((type, index) => {
                      return <Picker.Item key={index} value={type} label={type} />;
                    })}
                  </Picker>
                </View>
                <View style={{ marginTop: 25 }}>
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          this.state.submitted && this.state.school.length < 1 ? colors.red : colors.white,
                        paddingLeft: 10,
                      },
                    ]}
                  />
                ...
                <View style={{ marginTop: 25 }}>
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          this.state.submitted && this.state.faculty.length < 1 ? colors.red : colors.white,
                        paddingLeft: 10,
                      },
                    ]}
                  />
                ...
                <View style={{ marginTop: 25 }}>
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          this.state.submitted && this.state.department.length < 1 ? colors.red : colors.white,
                        paddingLeft: 10,
                      },
                    ]}
                  />
                ...
                <View style={{ marginTop: 25 }}>
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          this.state.submitted && this.state.level.length < 1 ? colors.red : colors.white,
                        paddingLeft: 10,
                      },
                    ]}
                  />
                ...
                <View style={{ marginTop: 25 }}>
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          this.state.submitted && this.state.courseName.length < 1 ? colors.red : colors.white,
                        paddingLeft: 10,
                      },
                    ]}
                  />
                ...
                <View style={{ marginTop: 25 }}>
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          this.state.submitted && this.state.courseCode.length < 1 ? colors.red : colors.white,
                        paddingLeft: 10,
                      },
                    ]}
                  />
          ...
          {this.state.photoNotes.map((photoNote, index) => {
            ...
            return (
              <TouchableOpacity
                ...
                key={index}
                style={{ flex: 1, marginBottom: 2, backgroundColor: colors.white, flexDirection: 'row' }}
              >
                <View
                  style={{
                    flex: 0.8,
                ...
                >
                  ...
                  <View>
                    <Text style={{ fontSize: 16, marginTop: 5, fontWeight: '200', color: '#000' }}>
                      {capitalize(photoNote.faculty)} - {capitalize(photoNote.department)}
                    </Text>
                  </View>
                  <View>
                    <Text style={{ fontSize: 16, marginTop: 5, fontWeight: '200', color: '#000' }}>
                      {capitalize(photoNote.courseCode)} - {capitalize(photoNote.courseName)}
                    </Text>
                  </View>
                </View>
              </TouchableOpacity>

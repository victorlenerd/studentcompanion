...
import { View, Text, ActivityIndicator, StatusBar, ScrollView, TouchableHighlight, Alert } from 'react-native';
      ...
      return (
        <View style={{ marginTop: 100, marginBottom: 100 }}>
          ...
          <Button
            ...
            text="Ok, Got It!"
          />
          <ButtonInActive onPress={this.sendActivationCode.bind(this)} text="Resend Code Now." />
        </View>
      );
    } else {
      return (
        <View style={{ marginTop: 100, marginBottom: 100 }}>
          ...
          <Text style={{ color: colors.white, fontSize: 18, textAlign: 'center', marginBottom: 25, marginTop: 25 }}>
            You can't use your account on more than one device. You can deactivate the original device and activate this
            new device.
          </Text>
          <Button onPress={this.sendActivationCode.bind(this)} text="Activate New Device" />
          <ButtonInActive onPress={this.signout.bind(this)} text="No Not Now." />
        </View>
      );
    }
  }

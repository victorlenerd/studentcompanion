...
class StudyTime extends Component {
  ...
  _deleteReminder(index) {
    ...
    this.props.deleteReminder(index).then(reminders => {
      this.setState({ reminders });
    });
  }
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <View>
                    <Text style={{ fontSize: 16, marginTop: 5, fontWeight: '200' }}>
                ...
                <View style={{ flex: 0.2, alignItems: 'center', justifyContent: 'center' }}>
                  <TouchableOpacity
                    onPress={() => this._deleteReminder(index)}
                    style={{
                      width: 30,
                      height: 30,
                      alignItems: 'center',
                  ...
                  >
                    <View style={{ width: 15, height: 3, backgroundColor: colors.white }} />
                  </TouchableOpacity>
                </View>
              </View>
            );

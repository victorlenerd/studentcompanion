...
!(function(t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define([], e)
      : 'object' == typeof exports ? (exports.Quill = e()) : (t.Quill = e());
})(this, function() {
  return (function(t) {
    function e(r) {
          ...
          return (
            ...
            (e.prototype.update = function(t) {
              ...
              t.forEach(function(t) {
                t.target === e.domNode &&
                  'childList' === t.type &&
                  (n.push.apply(n, t.addedNodes), o.push.apply(o, t.removedNodes));
              }),
                ...
                n
                  ...
                  .forEach(function(t) {
                    ...
                    (o.next == n && null != o.next) ||
                      (null != o.parent && o.parent.removeChild(e), e.insertBefore(o, n));
                  });
            }),
            e
          );
        ...
        o = (function() {
          ...
          return (
            ...
            (t.prototype.insertInto = function(t, e) {
              if (
                (null != this.parent && this.parent.children.remove(this), t.children.insertBefore(this, e), null != e)
              )
                var n = e.domNode;
                ...
                var r = function(t, e) {
                  ...
                  l = function(t) {
                    null != t.domNode[i.DATA_KEY] &&
                      ...
                      (t instanceof o['default'] && t.children.forEach(l), t.optimize());
                  },
                  s = e,
                  u = 0;
                s.length > 0;
            ...
            (e.prototype.update = function(e) {
              ...
              (e = e || this.observer.takeRecords()),
                ...
                null != this.domNode[i.DATA_KEY].mutations &&
                  t.prototype.update.call(this, this.domNode[i.DATA_KEY].mutations),
                this.optimize(e);
            }),
            (e.blotName = 'scroll'),
    ...
    function(t, e, n) {
      ...
      function i(t, e) {
        if (
          ((e = (0, k['default'])(!0, { container: t, modules: { clipboard: !0, keyboard: !0, history: !0 } }, e)),
          null == e.theme || e.theme === T.DEFAULTS.theme)
        )
          e.theme = N['default'];
        else if (((e.theme = T['import']('themes/' + e.theme)), null == e.theme))
        ...
        var r = Object.keys(n.modules).concat(Object.keys(e.modules)),
          o = r.reduce(function(t, e) {
            ...
            return (
              null == n
                ? q.error('Cannot load ' + e + ' module. Are you sure you registered it?')
                : (t[e] = n.DEFAULTS || {}),
              t
            );
          }, {});
      ...
      var f = n(20),
        ...
        T = (function() {
          function t(e) {
            ...
            if ((o(this, t), (r = i(e, r)), (this.container = r.container), null == this.container))
            ...
            this.container.classList.add('ql-container'),
              ...
              (this.scroll = _['default'].create(this.root, { emitter: this.emitter, whitelist: r.formats })),
              ...
              this.theme.init(),
              this.pasteHTML('<div class=\'ql-editor\' style="white-space: normal;">' + l + '<p><br></p></div>'),
              this.history.clear(),
              r.readOnly && this.disable(),
              r.placeholder && this.root.setAttribute('data-placeholder', r.placeholder),
          ...
          return (
            c(t, null, [
              ...
              },
              {
                ...
                value: function(t) {
                  return (
                    null == this.imports[t] && q.error('Cannot import ' + t + '. Are you sure it was registered?'),
                    this.imports[t]
                  );
                },
              },
              {
                ...
                value: function(t, e) {
                  ...
                  if ('string' != typeof t) {
                    ...
                    null == this.imports[t] || r || q.warn('Overwriting ' + t + ' with', e),
                      (this.imports[t] = e),
            ...
            c(t, [
              ...
              },
              {
                ...
                value: function(t, e, n, r, o) {
                  ...
                  return (
                    this.selection.setRange(c, !0, v['default'].sources.SILENT), this.selection.scrollIntoView(), f
                  );
                },
              },
              {
    ...
    function(t, e, n) {
      ...
      (s.prototype.insert = function(t, e) {
        ...
        return 0 === t.length
          ? this
          : ((n.insert = t), 'object' == typeof e && Object.keys(e).length > 0 && (n.attributes = e), this.push(n));
      }),
                ...
                switch (t[0]) {
                  ...
                  case r.EQUAL:
                    ...
                    var a = u.next(i),
                      s = c.next(i);
                    o(a.insert, s.insert)
                      ? e.retain(i, l.attributes.diff(a.attributes, s.attributes))
                      : e.push(s)['delete'](i);
                }
                n -= i;
              }
    ...
    function(t, e) {
      ...
      function r(t, e) {
        ...
        if (a != -1)
          return (
            (r = [[f, i.substring(0, a)], [h, l], [f, i.substring(a + l.length)]]),
            t.length > e.length && (r[0][0] = r[2][0] = c),
            r
          );
        if (1 == l.length) return [[c, t], [f, e]];
        var u = s(t, e);
        if (u) {
          var p = u[0],
            d = u[1],
              ...
              r + o > 1
                ? (0 !== r &&
                  ...
                  0 === r
                    ...
                    : 0 === o ? t.splice(n - r, r + o, [c, i]) : t.splice(n - r - o, r + o, [c, i], [f, s]),
                  (n = n - r - o + (r ? 1 : 0) + (o ? 1 : 0) + 1))
                : 0 !== n && t[n - 1][0] == h ? ((t[n - 1][1] += t[n][1]), t.splice(n, 1)) : n++,
                (o = 0),
                (r = 0),
                (i = ''),
                (s = '');
    ...
    function(t, e, n) {
      ...
      function o(t) {
        return (
          ...
          ('function' == typeof t.copy && 'function' == typeof t.slice && !(t.length > 0 && 'number' != typeof t[0]))
        );
      }
      function i(t, e, n) {
        var i, c;
          ...
          if (((t = arguments[c]), null != t))
            for (e in t)
              (n = u[e]),
                ...
                u !== r &&
                  (h && r && (i(r) || (a = o(r)))
                    ? (a ? ((a = !1), (s = n && o(n) ? n : [])) : (s = n && i(n) ? n : {}), (u[e] = l(h, s, r)))
        ...
        l = {
          ...
          length: function(t) {
            return 'number' == typeof t['delete']
              ? t['delete']
              : 'number' == typeof t.retain ? t.retain : 'string' == typeof t.insert ? t.insert.length : 1;
          },
        };
          ...
          if (e) {
            ...
            return (
              ...
              'number' == typeof e.retain
                ? (o.retain = t)
                : 'string' == typeof e.insert ? (o.insert = e.insert.substr(n, t)) : (o.insert = e.insert),
              o
            );
          }
          return { retain: 1 / 0 };
        ...
        (r.prototype.peekType = function() {
          return this.ops[this.index]
            ? 'number' == typeof this.ops[this.index]['delete']
              ? 'delete'
              : 'number' == typeof this.ops[this.index].retain ? 'retain' : 'insert'
            : 'retain';
        }),
        (t.exports = l);
    },
      ...
      function l(t, e) {
        return Object.keys(e).reduce(function(n, r) {
          return null == t[r]
            ...
            : (e[r] === t[r]
                ? (n[r] = e[r])
                : Array.isArray(e[r]) ? e[r].indexOf(t[r]) < 0 && (n[r] = e[r].concat([t[r]])) : (n[r] = [e[r], t[r]]),
              n);
        }, {});
      }
      function a(t) {
        ...
        S = (function() {
          function t(e, n) {
            i(this, t),
              (this.scroll = e),
              (this.emitter = n),
              this.emitter.on(v['default'].events.SCROLL_UPDATE, this.update.bind(this, null)),
            ...
            c(t, [
              ...
              },
              {
                ...
                value: function(t, e, n) {
                  ...
                  return (
                    this.scroll.insertAt(t, e, n), this.update(new h['default']().retain(t).insert(o({}, e, n)), r)
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function(t, e, n) {
                  var r = this.getText(t, e),
                    ...
                    c = new h['default']();
                  null != l &&
                    ((s = l instanceof _['default'] ? l.newlineIndex(a) - a + 1 : l.length() - a),
                    (c = l
                      .delta()
                      .slice(a, a + s - 1)
                      .insert('\n')));
              ...
              },
              {
                ...
                value: function(t) {
                  var e = this,
                    ...
                    o = this.delta;
                  if (
                    (1 === r.length && 'characterData' === r[0].type && g['default'].find(r[0].target)
                      ? !(function() {
                      ...
                      : ((this.delta = this.getDelta()),
                        (t && (0, N['default'])(o.compose(t), this.delta)) || (t = o.diff(this.delta))),
                    t.length() > 0)
                  ) {
                    var i,
                      l = [v['default'].events.TEXT_CHANGE, t, o, n];
                    if (
                      ((i = this.emitter).emit.apply(i, [v['default'].events.EDITOR_CHANGE].concat(l)),
      ...
      (r.prototype._events = void 0),
        ...
        (r.prototype.on = function(t, e, r) {
          ...
          return (
            ...
            this._events[l]
              ? this._events[l].fn ? (this._events[l] = [this._events[l], o]) : this._events[l].push(o)
              : (this._events[l] = o),
            this
          );
        }),
          ...
          if (e)
            if (l.fn) (l.fn !== e || (r && !l.once) || (n && l.context !== n)) && a.push(l);
              ...
              for (var s = 0, u = l.length; s < u; s++)
                (l[s].fn !== e || (r && !l[s].once) || (n && l[s].context !== n)) && a.push(l[s]);
          return a.length ? (this._events[o] = 1 === a.length ? a[0] : a) : delete this._events[o], this;
        }),
        (r.prototype.removeAllListeners = function(t) {
          return this._events
            ? (t ? delete this._events[i ? i + t : t] : (this._events = i ? {} : Object.create(null)), this)
            : this;
        }),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  null != t &&
                    ...
                    this.statics.formats(this.domNode) === t.statics.formats(t.domNode) &&
                  ...
                  u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'replace', this).call(this, t),
                    [].slice.call(this.domNode.querySelectorAll('*')).forEach(function(t) {
                      ...
                      null == e
                        ...
                        : e instanceof p['default'].Embed ? e.remove() : e.unwrap();
                    });
                },
              },
            ],
              ...
              value: function() {
                return (
                  null == this.cache.length &&
                    (this.cache.length =
                      u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'length', this).call(this) + k),
                  this.cache.length
                );
              },
            },
              ...
              [
                {
                  ...
                  value: function(t, n) {
                    0 === t.children.length &&
                      s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'insertInto', this).call(
                        this,
                        t,
                        n
                      );
    ...
    function(t, e, n) {
      ...
      (v.allowedChildren = [v, f['default'], p['default']]),
        (v.order = ['cursor', 'inline', 'code', 'underline', 'strike', 'italic', 'bold', 'script', 'link']),
        (e['default'] = v);
    },
    function(t, e, n) {
      'use strict';
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (!this.selection.composing && null != this.parent) {
                    for (
                      var n = this.textNode, r = this.selection.getNativeRange();
                      null != this.domNode.lastChild && this.domNode.lastChild !== this.textNode;

                    )
                      this.domNode.parentNode.insertBefore(this.domNode.lastChild, this.domNode);
                    this.textNode.data !== e.CONTENTS &&
                      ((this.textNode.data = this.textNode.data.split(e.CONTENTS).join('')),
                      ...
                      null != r &&
                        r.start.node === n &&
                        r.end.node === n &&
                        this.selection.emitter.once(y['default'].events.SCROLL_OPTIMIZE, function() {
            ...
            i(this, t),
              ...
              this.emitter.on(b['default'].events.SCROLL_BEFORE_UPDATE, function() {
                ...
                null != t &&
                  ...
                  r.emitter.once(b['default'].events.SCROLL_UPDATE, function() {
                    try {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (
                    ...
                    if (
                      ((i = this.emitter).emit.apply(i, [b['default'].events.EDITOR_CHANGE].concat(l)),
    ...
    function(t, e, n) {
      ...
      (s.DEFAULTS = { modules: {} }), (s.themes = { default: s }), (e['default'] = s);
    },
    function(t, e, n) {
      'use strict';
      function r(t) {
                    ...
                    n = function r(t, e, n) {
                      ...
                      return (
                        t.children.forEachAt(e, n, function(t, e, n) {
                          a(t) ? o.push(t) : t instanceof h['default'].Container && (o = o.concat(r(t, e, i))),
                            (i -= n);
                        }),
                        o
                      );
    ...
    function(t, e, n) {
      ...
      var O = (function() {
        ...
        H = [L.AlignStyle, C.BackgroundStyle, M.ColorStyle, I.DirectionStyle, R.FontStyle, B.SizeStyle].reduce(function(
          t,
          e
        ) {
                ...
                value: function(t) {
                  ...
                  return (
                    c(l, '\n') &&
                      ...
                      (l = l.compose(new k['default']().retain(l.length() - 1)['delete'](1))),
                    ...
                    this.container.focus(),
                      setTimeout(function() {
                        (r = r.concat(e.convert())),
                          ...
                          e.quill.setSelection(r.length() - n.length, N['default'].sources.SILENT),
    ...
    function(t, e, n) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.AlignStyle = e.AlignClass = void 0);
      var o = n(2),
        i = r(o),
        l = { scope: i['default'].Scope.BLOCK, whitelist: ['right', 'center', 'justify'] },
    ...
    function(t, e, n) {
      ...
      var o = n(2),
        i = r(o),
        l = n(47),
        a = new i['default'].Attributor.Class('background', 'ql-bg', { scope: i['default'].Scope.INLINE }),
        s = new l.ColorAttributor('background', 'background-color', { scope: i['default'].Scope.INLINE });
    ...
    function(t, e, n) {
      ...
      var a = (function() {
        ...
        h = new c['default'].Attributor.Class('color', 'ql-color', { scope: c['default'].Scope.INLINE }),
    ...
    function(t, e, n) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.DirectionStyle = e.DirectionClass = void 0);
      var o = n(2),
        i = r(o),
    ...
    function(t, e, n) {
      ...
      var o = n(2),
        i = r(o),
        l = { scope: i['default'].Scope.INLINE, whitelist: ['serif', 'monospace'] },
    ...
    function(t, e, n) {
      ...
      function s(t, e) {
        ...
        var r = Object.keys(e.format).reduce(function(t, n) {
          return (
            x['default'].query(n, x['default'].Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]), t
          );
        }, {});
          ...
          Object.keys(e.format).forEach(function(t) {
            null == r[t] &&
              (Array.isArray(e.format[t]) ||
                ('link' !== t && n.quill.format(t, e.format[t], E['default'].sources.USER)));
          });
      }
      function u(t) {
        return {
      ...
      function f(t) {
        ...
        if (
          ('object' === ('undefined' == typeof t ? 'undefined' : h(t)) && (t = (0, v['default'])(t, !1)),
          'string' == typeof t.key)
        )
        ...
        L = (function(t) {
          function e(t, n) {
            ...
            return (
              ...
              r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0, prefix: /^.?$/ }, function(t) {
                0 !== t.index &&
                  (this.quill.deleteText(t.index - 1, 1, E['default'].sources.USER),
                  this.quill.selection.scrollIntoView());
              }),
              r.addBinding({ key: e.keys.DELETE }, { collapsed: !0, suffix: /^$/ }, function(t) {
                              ...
                              if (Array.isArray(e.format)) {
                                ...
                                !Object.keys(e.format).every(function(t) {
                                  return e.format[t] === !0
                                    ...
                                    : e.format[t] === !1
                                      ? null == k.format[t]
                                      : (0, g['default'])(e.format[t], k.format[t]);
                                })
                              )
                                return !1;
                              return (
                                !(null != e.prefix && !e.prefix.test(k.prefix)) &&
                                (!(null != e.suffix && !e.suffix.test(k.suffix)) && e.handler.call(t, i, k) !== !0)
                              );
                            });
                          E && n.preventDefault();
                        }
      ...
      (L.keys = { BACKSPACE: 8, TAB: 9, ENTER: 13, ESCAPE: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, DELETE: 46 }),
        (L.DEFAULTS = {
          bindings: {
            bold: c('bold'),
            italic: c('italic'),
            ...
            indent: {
              ...
              handler: function(t, e) {
                return (
                  !(!e.collapsed || 0 === e.offset) || void this.quill.format('indent', '+1', E['default'].sources.USER)
                );
              },
            },
            outdent: {
              ...
              handler: function(t, e) {
                null != e.format.indent
                  ...
                  : null != e.format.blockquote
                    ? this.quill.format('blockquote', !1, E['default'].sources.USER)
                    : null != e.format.list && this.quill.format('list', !1, E['default'].sources.USER);
              },
            },
            ...
            tab: {
              ...
              handler: function(t, e) {
                e.collapsed || this.quill.scroll.deleteAt(t.index, t.length),
                  this.quill.insertText(t.index, '\t', E['default'].sources.USER),
                  this.quill.setSelection(t.index + 1, E['default'].sources.SILENT);
              },
            },
            'list empty enter': {
              key: L.keys.ENTER,
              ...
              handler: function(t, e) {
                this.quill.format('list', !1, E['default'].sources.USER),
                  e.format.indent && this.quill.format('indent', !1, E['default'].sources.USER);
              },
            },
            'header enter': {
              key: L.keys.ENTER,
              ...
              handler: function(t) {
                this.quill.scroll.insertAt(t.index, '\n'),
                  this.quill.formatText(t.index + 1, 1, 'header', !1, E['default'].sources.USER),
                  this.quill.setSelection(t.index + 1, E['default'].sources.SILENT),
                  this.quill.selection.scrollIntoView();
              },
            },
            'list autofill': {
              ...
              handler: function(t, e) {
                ...
                this.quill.scroll.deleteAt(t.index - n, n),
                  ...
                  this.quill.setSelection(t.index - n, E['default'].sources.SILENT);
              },
            },
          },
        }),
    ...
    function(t, e, n) {
      ...
      var a = (function() {
            ...
            a(e, [
              {
                ...
                value: function(t, n) {
                  ...
                  return 0 === n
                    ? (this.remove(t), !0)
                    : s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'add', this).call(this, t, n);
                },
              },
              {
                key: 'value',
                value: function(t) {
                  return (
                    parseInt(
                      s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'value', this).call(this, t)
                    ) || void 0
                  );
                },
              },
        ...
        h = new f('indent', 'ql-indent', { scope: c['default'].Scope.BLOCK, whitelist: [1, 2, 3, 4, 5, 6, 7, 8] });
      e.IndentClass = h;
    },
    function(t, e, n) {
      'use strict';
              ...
              [
                {
                  ...
                  value: function(t, n) {
                    t !== m.blotName || n
                      ? u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'format', this).call(this, t, n)
                      : this.replaceWith(p['default'].create(this.statics.scope));
                  },
                },
                {
                  key: 'remove',
              ...
              [
                {
                  ...
                  value: function(t, n) {
                    return t === this.statics.blotName && n
                      ? ((n = this.constructor.sanitize(n)), void this.domNode.setAttribute('href', n))
                      : u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'format', this).call(this, t, n);
                  },
                },
              ],
                ...
                value: function(t) {
                  return 'super' === t
                    ...
                    : 'sub' === t
                      ...
                      : s(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(this, t);
                },
              },
              {
                key: 'formats',
              ...
              [
                ...
                },
                {
                  ...
                  value: function n(t) {
                    var n = {};
                    return (
                      t.hasAttribute('height') && (n.height = t.getAttribute('height')),
                      t.hasAttribute('width') && (n.width = t.getAttribute('width')),
                      n
                    );
                  },
                },
              ...
              [
                {
                  ...
                  value: function(t) {
                    var n = u(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(this, t);
                    return (
                      'string' == typeof t && (katex.render(t, n), n.setAttribute('data-value', t)),
                  ...
                  if (n) {
                    if (
                      ...
                      if (null != this.quill.scroll.whitelist && null == this.quill.scroll.whitelist[n])
                        return void k.warn('ignoring attaching to disabled format', n, t);
                      if (null == b['default'].query(n))
                        return void k.warn('ignoring attaching to nonexistent format', n, t);
                    }
          ...
          handlers: {
            ...
            direction: function(t) {
              ...
              'rtl' === t && null == e
                ...
                : t || 'right' !== e || this.quill.format('align', !1, m['default'].sources.USER),
            ...
            l(t, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return (
                    t.classList.add('ql-picker-label'), (t.innerHTML = s['default']), this.container.appendChild(t), t
                  );
                },
              },
              {
            ...
            a(e, [
              {
                key: 'buildItem',
                value: function(t) {
                  var n = s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'buildItem', this).call(
                    this,
                    t
                  );
                ...
                value: function() {
                  this.root.classList.toggle('ql-out-top', this.root.offsetTop <= 0),
                    ...
                    this.root.classList.toggle(
                      'ql-out-bottom',
                      this.root.offsetTop + this.root.offsetHeight >= this.quill.root.offsetHeight
                    );
                },
              },
              {
          ...
          s(e, [
            {
              ...
              value: function() {
                ...
                a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'listen', this).call(this),
                  this.root.querySelector('.ql-close').addEventListener('click', function(e) {
            ...
            s(e, [
              {
                key: 'addModule',
                value: function(t) {
                  var n = u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'addModule', this).call(
                    this,
                    t
                  );
                ...
                value: function(t) {
                  ...
                  this.pickers = t.map(function(t) {
                    if (t.classList.contains('ql-align'))
                      return null == t.querySelector('option') && a(t, T), new x['default'](t, q['default'].align);
                    if (t.classList.contains('ql-background') || t.classList.contains('ql-color')) {
                      ...
                      return (
                        null == t.querySelector('option') && a(t, S, 'background' === e ? '#ffffff' : '#000000'),
                    ...
                    return (
                      null == t.querySelector('option') &&
                        (t.classList.contains('ql-font')
                          ? a(t, P)
                          : t.classList.contains('ql-header') ? a(t, L) : t.classList.contains('ql-size') && a(t, C)),
                      new E['default'](t)
                    );
                  });
                  var n = function() {
              ...
              value: function() {
                ...
                this.textbox.addEventListener('keydown', function(e) {
                  b['default'].match(e, 'enter')
                    ...
                    : b['default'].match(e, 'escape') && (t.cancel(), e.preventDefault());
                });
              },
            },
            {
              ...
              value: function() {
                ...
                switch (this.root.getAttribute('data-mode')) {
                  case 'link':
                    ...
                    this.linkRange
                      ? (this.quill.formatText(this.linkRange, 'link', t, y['default'].sources.USER),
                        delete this.linkRange)
                      : (this.restoreFocus(), this.quill.format('link', t, y['default'].sources.USER)),
                      (this.quill.root.scrollTop = e);
                    break;
                  case 'video':
                    var n =
                      t.match(/^(https?):\/\/(www\.)?youtube\.com\/watch.*v=([a-zA-Z0-9_-]+)/) ||
                      t.match(/^(https?):\/\/(www\.)?youtu\.be\/([a-zA-Z0-9_-]+)/);
                    n
                      ? (t = n[1] + '://www.youtube.com/embed/' + n[3] + '?showinfo=0')
                      : (n = t.match(/^(https?):\/\/(www\.)?vimeo\.com\/(\d+)/)) &&
                        (t = n[1] + '://player.vimeo.com/video/' + n[3] + '/');
                  case 'formula':
                    var r = this.quill.getSelection(!0),
                      o = r.index + r.length;
                    null != r &&
                      (this.quill.insertEmbed(o, this.root.getAttribute('data-mode'), t, y['default'].sources.USER),
                      'formula' === this.root.getAttribute('data-mode') &&
                        this.quill.insertText(o + 1, ' ', y['default'].sources.USER),
    ...
    function(t, e, n) {
      ...
      var a = (function() {
        ...
        O = (function(t) {
          function e(t, n) {
            o(this, e),
              null != n.modules.toolbar && null == n.modules.toolbar.container && (n.modules.toolbar.container = _);
            var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
              ...
              value: function() {
                ...
                s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'listen', this).call(this),
                  ...
                  this.root.querySelector('a.ql-remove').addEventListener('click', function(e) {
                    null != t.linkRange &&
                      (t.restoreFocus(),
                      t.quill.formatText(t.linkRange, 'link', !1, p['default'].sources.USER),
                      delete t.linkRange),
                      e.preventDefault(),
                      t.hide();
                  }),

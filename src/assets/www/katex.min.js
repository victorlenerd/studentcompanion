  ...
  return (function a(e, t, r) {
  ...
  })(
    {
      1: [
        ...
        { './src/ParseError': 6, './src/Settings': 8, './src/buildTree': 13, './src/parseTree': 22, './src/utils': 25 },
      ],
      2: [
        function(e, t, r) {
          'use strict';
      ...
      11: [
        function(e, t, r) {
          ...
          w.supsub = function(e, t) {
            ...
            var k = 0.5 / o.metrics.ptPerEm / b + 'em';
            var S;
            if (!e.value.sup) {
              v = Math.max(v, c.metrics.sub1, h.height - 0.8 * c.metrics.xHeight);
              ...
              f = Math.max(f, y, u.depth + 0.25 * c.metrics.xHeight);
              ...
              if (f - u.depth - (h.height - v) < 4 * M) {
                ...
                var T = 0.8 * c.metrics.xHeight - (f - u.depth);
                if (T > 0) {
                  f += T;
                  v -= T;
                }
              ...
              S = n.makeVList(
                [{ type: 'elem', elem: s, shift: v }, { type: 'elem', elem: a, shift: -f }],
                'individualShift',
                null,
                t
              );
          ...
          w.genfrac = function(e, t) {
            ...
            if (v === 0) {
              ...
              x = n.makeVList(
                [{ type: 'elem', elem: f, shift: y }, { type: 'elem', elem: c, shift: -d }],
                'individualShift',
                null,
                t
              );
              ...
              if (d - h.depth - (k + 0.5 * v) < g) {
                d += g - (d - h.depth - (k + 0.5 * v));
              }
          ...
          w.accent = function(e, t) {
            ...
            v = n.makeVList(
              [{ type: 'elem', elem: l }, { type: 'kern', size: -c }, { type: 'elem', elem: v }],
              'firstBaseline',
              null,
              t
            );
      ...
      13: [
        ...
        { './Options': 5, './Settings': 8, './Style': 9, './buildCommon': 10, './buildHTML': 11, './buildMathML': 12 },
      ],
      14: [
        function(e, t, r) {
          var a = e('./ParseError');
        ...
        function(e, t, r) {
          ...
          o('cases', {}, function(e) {
            var t = {
              ...
              arraystretch: 1.2,
              cols: [
                { type: 'align', align: 'l', pregap: 0, postgap: n.TEXT.metrics.quad },
      ...
      19: [
        function(e, t, r) {
          ...
          l('\\color', { numArgs: 2, allowedInText: true, greediness: 3, argTypes: ['color', 'original'] }, function(
            e,
            t
          ) {
            var r = t[0];

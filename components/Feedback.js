...
class Feedback extends Component {
    ...
    _submit() {
        ...
        if (this.state.feedback.length > 1) {
            ...
            .then((user)=> {
                this.props.sendFeedback(user.$id, this.state.feedback)
                .then(()=> {
                    Alert.alert("Sent", "Thanks for the feedback.",[
    ...
    render () {
        return (
            <View style={{width,height, flexDirection: "column", backgroundColor: colors.lightBlue, borderTopColor: colors.accent, borderTopWidth: 2}}>
                <StatusBar
                ...
                <View style={{height: 300, padding: 20}}>
                    <TextInput                             
                        ...
                        style={[main.textInput, {height: 300, backgroundColor: (this.state.submitted && this.state.feedback.length < 1) ? colors.red : colors.lightBlue, fontSize: 18}]} />
                </View>

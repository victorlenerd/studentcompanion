...
class ForgotPassword extends Component {
    ...
    _send() {
        ...
        if (!this._validEmail(this.state.email)) {
            ...
            store.dispatch(SendResetPasswordEmail(this.state.email))
            .then(()=> {
                ...
                <KeyboardAwareScrollView>
                    <View style={[main.content, { flex:1, flexDirection:"column" }]}>
                        ...
                        <View style={{flex: 0.2, paddingTop: 50}}>
                            <Text style={{fontSize: 20, fontWeight: '300', color: colors.primary, marginBottom: 20}}>Forgot Password</Text>
                            <TextInput
                                placeholder="Email"
                            ...
                            <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                                <Button onPress={this._send.bind(this)} text="Send"></Button>
                            </View>
                        </View>
                    </View>
                </KeyboardAwareScrollView>

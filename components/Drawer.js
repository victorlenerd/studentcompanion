        ...
        return (
            <View style={{flex: 1, backgroundColor: colors.lightBlue}}>
                ...
                <View style={{
                    ...
                    <View style={{height: 50, width: 50, borderRadius: 15, elevation: 5, shadowColor: '#000000', marginBottom: 15, shadowOffset: { width: 2, height: 3}, shadowOpacity: 0.3}}>
                        <Image
                            resizeMode="contain"
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => { 
                                Share.share({
                                    ...
                                    url: (Platform.OS === 'ios') ? 'https://itunes.apple.com/ng/app/student-companion/id1238513973?mt=8': 'https://play.google.com/store/apps/details?id=com.courseapp', 

                ...
                <View style={{flexDirection: "column", flex: 1}}>
                    <ScrollView style={{flex: 1}}>
                        {this.props.notes.map((note, index)=> {
                            return (
                                <TouchableOpacity style={{flex: 1, borderTopWidth: 1, borderTopColor: "#f1f1f1", flexDirection: "row",  padding: 20, justifyContent: "space-between", alignItems: "center"}} key={index} onPress={()=> this._openNote(note) }>

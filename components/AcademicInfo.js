                ...
                <View style={[main.container, {backgroundColor: colors.black}]}>
                    ...
                    <View style={[main.content,{flex: 1, justifyContent:"space-between", alignItems: "center",  backgroundColor: colors.black, flexDirection:"column"}]}>
                        <View style={{marginTop: 100, marginBottom: 100}}>
                            <Text style={{color: colors.white, fontSize: 32, textAlign:"center", fontWeight: "200"}}>Academic Info.</Text>
                            <Text style={{color: colors.white, fontSize: 18, textAlign:"center", marginBottom: 25, marginTop: 25}}>Please set your academic information, so you can get courses.</Text>
                            <Button onPress={()=> { navigator.searchCourses({
                                    settingAcademicInfo: true
                                }); 
                            }} text="Ok, Got It!"></Button>
                        </View>
                    </View>
                </View>
            </ScrollView>
